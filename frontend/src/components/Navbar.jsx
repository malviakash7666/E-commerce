...
const Navbar = () => {
  ...
  return (
    <div className='flex   items-center justify-between py-5 text-base sm:font-medium'>
        <Link to={"/"}>
<h1 onClick={()=>navigate("/")} className="text-3xl text-black">WebCart</h1>
</Link>
...
<div className="flex items-center gap-6">
    <img onClick={()=>setShowSearch(true)} src={assets.search_icon} className='ml-3 w-5 cursor-pointer' alt="" />
